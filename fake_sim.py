...
def main():
    ...
    def get_get_switch_by_controller():
        """
    ...
    def update_state():
        ...
        # lambda(t) = lambda0 (1 + A sin (2 pi t / P))
        ...
        lambda_0 = base_rates
        A = fluctuation_amplitudes * 10 #TODO for test only I'm multiplying it to make them larger.
        ...
        #TODO FOR TEST ONLY 
        multiplier = 30
        expected_in_duration = (expected_events_end - expected_events_begin ) * multiplier
